...
#カテゴリ名の付与、小計値の計算(GETの他にPOSTでも使用するので関数化した)
def calc_category_sum(balances):
...
class BalanceView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        month_list = []
        for month in months:
            month_list.append(calc_category_sum(month))
    ...
    def post(self, request, *args, **kwargs):
        ...
        year = calc_category_sum(year)
        month = calc_category_sum(month)
